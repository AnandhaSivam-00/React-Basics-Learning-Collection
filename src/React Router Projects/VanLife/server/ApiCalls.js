...
export const getVans = async () => {
  try {
    ...
    console.log("Error getting vans:", error);
    return;
  }
}
...
export const getVan = async (id) => {
  ...
  try {
    ...
    const vanDoc = querySnapshot.docs[0];
    ...
    console.log("Error getting van:", error);
    return;
  }
}
...
export const getHostVans = async () => {
  try {
    ...
    console.log("Error in getting host vans:", error);
    return;
  }
}
...
export const getHostVan = async (id) => {
  try {
    const q = query(vansCollectionRef, where("id", "==", id), where("hostId", "==", "123"));
    const querySnapshot = await getDocs(q);
    ...
    console.log("Error in fetching host van", error);
    return;
  }
}
...
// export async function addVansToFirestore() {
//     // Van data to be added
//     const vansData = [
//       { 
//         id: "1", 
...
//     } 
//     catch (error) {
//       console.error("Error adding vans to Firestore:", error);
//       return false;
//     }
//   }